...
# -Wno-restrict -Wno-maybe-uninitialized -Werror
...
# -fomit-frame-pointer -fno-stack-clash-protection -fno-strict-overflow
...
.ascii "->TASK_threadsp $2840 offsetof(struct task_struct, thread.sp)"	#
# 0 "" 2
# arch/x86/kernel/asm-offsets.c:38: 	OFFSET(TASK_stack_canary, task_struct, stack_canary);
# 38 "arch/x86/kernel/asm-offsets.c" 1
	
.ascii "->TASK_stack_canary $1352 offsetof(struct task_struct, stack_canary)"	#
# 0 "" 2
